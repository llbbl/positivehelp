...
export const siteConfig = {
  ...
  description: 'A platform for sharing positive messages, uplifting quotes, and spreading good vibes. Submit your own positive content to brighten someone\'s day.',
  url: process.env.NEXT_PUBLIC_APP_URL || 'https://positive.help',
  author: 'positive.help team',
  keywords: ['positive messages', 'uplifting quotes', 'motivation', 'inspiration', 'good vibes', 'mental health', 'wellness', 'positivity'],
  social: {
 ...
 */
export function generateMessageDescription(messageText: string, authorName?: string): string {
