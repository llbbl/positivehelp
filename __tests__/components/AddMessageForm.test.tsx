...
describe('AddMessageForm', () => {
  ...
  it('shows correct placeholders', () => {
    ...
    expect(screen.getByPlaceholderText('Share something positive...')).toBeInTheDocument();
    expect(screen.getByPlaceholderText('Who said or wrote this? Leave blank for anonymous.')).toBeInTheDocument();
  });
  ...
  it('submits form with correct data when logged in', async () => {
    ...
    fireEvent.change(contentField, { target: { value: 'Test positive message' } });
