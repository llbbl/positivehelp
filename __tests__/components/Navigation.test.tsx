...
jest.mock('@clerk/nextjs', () => ({
  ...
  UserButton: ({ afterSignOutUrl }: any) => <div data-testid="user-button">User Button</div>,
}));
...
describe('Navigation', () => {
  it('renders the main navigation elements', () => {
    ...
    expect(screen.getByRole('link', { name: /positive\.help/i })).toHaveAttribute('href', '/');
  });
