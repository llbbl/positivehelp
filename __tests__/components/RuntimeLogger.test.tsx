...
describe('RuntimeLogger', () => {
  ...
  it('calls console.log with expected messages', () => {
    ...
    expect(consoleSpy).toHaveBeenCalledWith('--- RuntimeLogger: Client-Side Logging ---');
    expect(consoleSpy).toHaveBeenCalledWith('process.env.NEXT_PUBLIC_APP_URL:', process.env.NEXT_PUBLIC_APP_URL);
  });
