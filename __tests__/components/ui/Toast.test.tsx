...
describe('Toast Components', () => {
  ...
  describe('Toast', () => {
    it('renders with default props', () => {
      ...
      const toast = toasts.find(el => el.textContent?.includes('Toast content'));
    ...
    it('renders with default variant', () => {
      ...
      const toasts = screen.getAllByRole('status');
      const toast = toasts.find(el => el.textContent?.includes('Default toast'));
    ...
    it('renders with destructive variant', () => {
      ...
      const toasts = screen.getAllByRole('status');
      const toast = toasts.find(el => el.textContent?.includes('Destructive toast'));
      expect(toast).toHaveClass(
        'destructive',
        'group',
        'border-destructive',
    ...
    it('applies custom className', () => {
      ...
      const toasts = screen.getAllByRole('status');
      const toast = toasts.find(el => el.textContent?.includes('Custom toast'));
  ...
  describe('ToastTitle', () => {
    ...
    it('applies custom className', () => {
      render(
        <ToastProvider>
          <Toast open>
            <ToastTitle className="custom-title-class">
              Custom Title
            </ToastTitle>
          </Toast>
          <ToastViewport />
    ...
    it('forwards additional props', () => {
      render(
        <ToastProvider>
          <Toast open>
            <ToastTitle data-testid="test-title">
              Test Title
            </ToastTitle>
          </Toast>
          <ToastViewport />
