    ...
    <nav className="flex items-center justify-between p-4 bg-green-300 relative">
      ...
      <div className="flex items-center gap-2 md:gap-4">
        ...
        <div className="md:hidden">
          <Button size="sm" className="bg-white text-green-800 hover:bg-green-50 px-2">
            <PlusCircle className="w-4 h-4" />
            <Link href="/add" />
          </Button>
        </div>
        ...
        {isMenuOpen && (
          <div className="absolute top-full right-0 w-48 bg-green-300 p-4 md:hidden flex flex-col gap-2 shadow-lg z-50 rounded-bl-lg">
            <SignedIn>
              <Button variant="ghost" className="text-green-800 hover:bg-green-50 w-full justify-start">
                <Link href="/submissions">
                  Submissions
                </Link>
              </Button>
